from src.bm25_searcher import BM25Retriever
from src.semantic_searcher import SemanticRetriever
from src.rank_fusion import compute_rrf, get_top_k
...
class RAG:
    ...
    def sql_search(self, query: str, category_tag: str = "") -> str:
        ...
        try:
            ...
            normalized_query = self._normalize_query_brands(query)
